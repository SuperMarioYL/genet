...
import { resumeStatefulSet } from '../../services/api';
...
jest.mock('../../services/api', () => {
  ...
  return {
    deleteStatefulSet: fn(),
    resumeStatefulSet: fn(),
  };
});
...
describe('StatefulSetCard suspend state', () => {
  ...
  beforeEach(() => {
    ...
    (resumeStatefulSet as any).mockResolvedValue({});
  ...
  it('renders suspended state and resumes the workload', async () => {
    ...
    expect(resumeStatefulSet).toHaveBeenCalledWith('sts-alice-train');
